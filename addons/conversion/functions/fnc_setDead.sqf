...
private _unitConversion = _unit getVariable [QEGVAR(conversion,conversion), false];
diag_log _unitConversion;

if (_unitConversion) exitWith {
    [_unit, ACEGVAR(medical,STATE_MACHINE), _unitState, "Unconscious"] call CBA_statemachine_fnc_manualTransition;
};
