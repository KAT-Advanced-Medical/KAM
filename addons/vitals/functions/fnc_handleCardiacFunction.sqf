...
if IN_CRDC_ARRST(_unit) then {
    ...
    TRACE_8("HR1",_lastCycleHeartRate,_lastCycleCO2,_demandReturn,_strokeVolume,_defaultHeartRate,_strokeVolumeDifference,_volumeSupportHR,_hrTargetAdjustment);
