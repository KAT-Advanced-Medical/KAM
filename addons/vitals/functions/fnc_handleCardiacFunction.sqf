...
if IN_CRDC_ARRST(_unit) then {
    ...
    private _defaultstrokeVolume = 0.637561;
    ...
    TRACE_5("HR1",_lastCycleHeartRate,_lastCycleCO2,_demandReturn,_strokeVolume,_defaultHeartRate);
    ...
    private _modelHeartRate = 40 + ((_demandReturn / _strokeVolume) * (5.03336 * _defaultHeartRate));
