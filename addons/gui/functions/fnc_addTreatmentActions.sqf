...
private _actionPaths = ["ACE_Head", "ACE_Neck", "ACE_Torso", "ACE_Chest", "ACE_ArmLeft", "ACE_ArmRight", "ACE_LegLeft", "ACE_LegRight", "ACE_ArmUpperLeft", "ACE_ArmUpperRight", "ACE_LegUpperLeft", "ACE_LegUpperRight"];
...

{
    ...
    private _actionName = format [QACEGVAR(medical_gui,_%1), _configName];
