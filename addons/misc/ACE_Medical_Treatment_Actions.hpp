class ACE_Medical_Treatment_Actions {
    ...
    class SalineIV_Stand: SalineIV {
        ...
        items[] = {};
        callbackSuccess = QUOTE([ARR_5(_medic, _patient, _selectionName, 'SalineIV', ['ACE_salineIV'])] call FUNC(treatmentIV));
        itemConsumed = 0;
    };
    class SalineIV_Stand_500: SalineIV_Stand {
        ...
        callbackSuccess = QUOTE([ARR_5(_medic, _patient, _selectionName, 'SalineIV_500', ['ACE_salineIV_500'])] call FUNC(treatmentIV));
    };
    class SalineIV_Stand_250: SalineIV_Stand {
        ...
        callbackSuccess = QUOTE([ARR_5(_medic, _patient, _selectionName, 'SalineIV_250', ['ACE_salineIV_250'])] call FUNC(treatmentIV));
    };
