...
[{
  ...
  [_target, "quick_view", localize "STR_kat_aceBreathing_pulsoxy_Log", [round (_target getVariable ["ace_medical_heartRate", 80]), round (_target getVariable ["ace_medical_airwayStatus", 100])]] call ace_medical_fnc_addToLog;
