...
[_target, "quick_view", localize "STR_kat_aceAirway_airway_log", [[_player] call ace_common_fnc_getName, localize "STR_kat_aceAirway_Larynx_Display"]] call ace_medical_fnc_addToLog;
