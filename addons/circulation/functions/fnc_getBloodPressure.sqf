...
private _radBPDrop = _unit getVariable [QEGVAR(chemical,radBPDrop), 0];

[((round(_systolic + _changeSystolic * (_systolic / 80)) - _radBPDrop) max 0), ((round(_diastolic + _changeDiastolic * (_diastolic / 120)) - _radBPDrop) max 0)]
