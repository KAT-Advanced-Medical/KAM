class ACE_Medical_Treatment_Actions {
    ...
    class CheckDogtags: CheckPulse {
        ...
        callbackSuccess = QUOTE([ARR_2(_medic,_patient)] call FUNC(bloodTypeLog); [ARR_2(_medic,_patient)] call EFUNC(vitals,weightLog); [ARR_2(_medic,_patient)] call ACEFUNC(dogtags,checkDogtag););
        condition = "true";
        animationPatient = "";
        animationPatientUnconscious = "AinjPpneMstpSnonWrflDnon_rolltoback";
