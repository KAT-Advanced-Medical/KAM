...
class CfgVehicles {
    ...
    class kat_medicalSupplyCrate: ACE_medicalSupplyCrate {
        ...
        class TransportItems: TransportItems {
            ...
            MACRO_ADDITEM(kat_bloodIV_O_RhP,5);
            MACRO_ADDITEM(kat_bloodIV_O_RhN,5);
            MACRO_ADDITEM(kat_bloodIV_A_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_A_RhN,10);
            MACRO_ADDITEM(kat_bloodIV_B_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_B_RhN,10);
            MACRO_ADDITEM(kat_bloodIV_AB_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_AB_RhN,10);
            MACRO_ADDITEM(kat_bloodIV_O_500_RhP,5);
            MACRO_ADDITEM(kat_bloodIV_O_500_RhN,5);
            MACRO_ADDITEM(kat_bloodIV_A_500_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_A_500_RhN,10);
            MACRO_ADDITEM(kat_bloodIV_B_500_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_B_500_RhN,10);
            MACRO_ADDITEM(kat_bloodIV_AB_500_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_AB_500_RhN,10);
            MACRO_ADDITEM(kat_bloodIV_O_250_RhP,5);
            MACRO_ADDITEM(kat_bloodIV_O_250_RhN,5);
            MACRO_ADDITEM(kat_bloodIV_A_250_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_A_250_RhN,10);
            MACRO_ADDITEM(kat_bloodIV_B_250_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_B_250_RhN,10);
            MACRO_ADDITEM(kat_bloodIV_AB_250_RhP,10);
            MACRO_ADDITEM(kat_bloodIV_AB_250_RhN,10);
        };
    };
