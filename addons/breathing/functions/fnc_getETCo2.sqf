...
switch (true) do {
    ...
    //airways blocked
    case (_airwayObstructed || _airwayOccluded): {60};

    //tptx/hpx
    case (_hasHtx || _hasTptx): {22};
    ...
    default {
        _newEtco2 = 40;
        _newEtco2 = _newEtco2 - ((floor (_lostBlood / 0.5)) * 3);
        (14 max _newEtco2 min 99); //subtract 4mmhg of ETCo2 for each 500ml lost, clamped at minimum 14
    };
};