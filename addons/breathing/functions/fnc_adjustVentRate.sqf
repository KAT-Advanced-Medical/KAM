...
_target setVariable [QGVAR(attachedVent), false, true];
[{
    params ["_target"];
    _target setVariable [QGVAR(attachedVent), true, true];
    _target call FUNC(ventPFH);
}, [_target], _ventRate] call CBA_fnc_waitAndExecute;
