...
_patient setVariable [QGVAR(radInfectionLevel), 0, true];
_patient setVariable [QGVAR(radCritical), false, true];
_patient setVariable [QGVAR(radCollapseTimer), -1, true];
_patient setVariable [QGVAR(radMarrowRescueWindow), 0, true];
_patient setVariable [QGVAR(radProtectiveWindow), 0, true];
_patient setVariable [QGVAR(radChelationWindow), 0, true];
_patient setVariable [QGVAR(radAntibioticWindow), 0, true];
_patient setVariable [QGVAR(radAntiemeticWindow), 0, true];
_patient setVariable [QGVAR(radFilgrastimWindow), 0, true];
