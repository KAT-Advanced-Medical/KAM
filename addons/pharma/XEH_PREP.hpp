...
PREP(treatmentAdvanced_ApplyPressureBagLocal);
PREP(treatmentAdvanced_AtropineLocal);
PREP(treatmentAdvanced_AtropineOverdoseLocal);
PREP(treatmentAdvanced_BicarbonateOverdoseLocal);
...
PREP(treatmentAdvanced_CalciumChlorideOverdoseLocal);
PREP(treatmentAdvanced_CalciumGluconateOverdoseLocal);
...
PREP(treatmentAdvanced_DiazepamOverdoseLocal);
...
PREP(treatmentAdvanced_MetoprololOverdoseLocal);
...
PREP(treatmentAdvanced_RemovePressureBagLocal);
