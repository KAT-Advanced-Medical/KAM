...
if !(_caller getVariable ["aceP_soundplayed", false]) then {
    _caller setVariable ["aceP_soundplayed", true, true];
    _args spawn {
        ...
        sleep 1.5;
		if !(_caller getVariable ["aceP_soundplayed", false]) exitWith {};
        ...
        _caller setVariable ["aceP_soundplayed", false, true];
    };
};
