...
[{
    ...
    private _countTXAiV51 = [_patient, "syringe_kat_txa_5ml_2"] call ACEFUNC(medical_status,getMedicationCount);
    private _countTXAiM101 = [_patient, "syringe_kat_txa_10ml_1"] call ACEFUNC(medical_status,getMedicationCount);
    private _countTXAiM102 = [_patient, "syringe_kat_txa_10ml_2"] call ACEFUNC(medical_status,getMedicationCount);
    ...
    private _countEACAIV52 = [_patient, "syringe_kat_eaca_5ml_2"] call ACEFUNC(medical_status,getMedicationCount);
    ...
    if (_currentCoagFactors == _savedCoagFactors && _currentCoagFactors < _limitRegenCoagFactors) exitWith {
        ...
        if ((_countTXA > 0 || _countTXAiV51 > 0 || _countTXAiV52 > 0 || _countTXAiM101 > 0 || _countTXAiM102 > 0) || (_countEACA > 0 || _countEACAIV51 > 0 || _countEACAIV52 > 0)) then { // If TXA or EACA are in system add more factors
            if ((_countTXA > 0 || _countTXAiV51 > 0 || _countTXAiV52 > 0 || _countTXAiM101 > 0 || _countTXAiM102 > 0) && (_countEACA > 0 || _countEACAIV51 > 0 || _countEACAIV52 > 0) > 0) exitWith {
                _ammountToAdd = 4;
            };
            _ammountToAdd = 2;
        };
    ...
    if (_currentCoagFactors > _limitRegenCoagFactors && !(_cooldownON)) exitWith {
        ...
        if ((_countTXA > 0 || _countTXAiV51 > 0 || _countTXAiV52 > 0 || _countTXAiM101 > 0 || _countTXAiM102 > 0) || (_countEACA > 0 || _countEACAIV51 > 0 || _countEACAIV52 > 0)) exitWith {}; // If TXA or EACA is in system don't remove factor
