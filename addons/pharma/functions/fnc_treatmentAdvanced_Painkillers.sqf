 ...
 *
 * Example:
 * [player, cursorObject, "RightArm", "Painkillers", objNull, "kat_Painkiller"] call kat_pharma_fnc_treatmentAdvanced_Painkillers;
 *
 * Public: No
 */
...
[_patient, "TEST_KAT_PK"] call ACEFUNC(medical_treatment,addToTriageCard);
