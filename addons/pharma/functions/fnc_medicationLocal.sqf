...
[_patient, _className, _timeTillMaxEffect, _timeInSystem, _heartRateChange, _painReduce, _viscosityChange, _alphaFactor] call ACEFUNC(medical_status,addMedicationAdjustment);
