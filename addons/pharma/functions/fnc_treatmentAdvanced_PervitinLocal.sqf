...
/*
 * Author: Miss Heda, YonV, MiszczuZPolski
 * 
 *
 * Arguments:
 * 0: Patient <OBJECT>
...
if (isNil "TAG_originalSwayFactor")    then {TAG_originalSwayFactor = ace_advanced_fatigue_swayFactor;};

	[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = TAG_originalSwayFactor * 0.3;
},
[_patient],
15] call CBA_fnc_waitAndExecute;
	...
	[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = TAG_originalSwayFactor * 0.5 ;
},
[_patient],
...
[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = TAG_originalSwayFactor * 1;
},
[_patient],
...
[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = (TAG_originalSwayFactor * 1.3) min 2;
},
[_patient],
120] call CBA_fnc_waitAndExecute; /// 2m
...
[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = (TAG_originalSwayFactor * 1.5) min 2;
},
[_patient],
...
[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = (TAG_originalSwayFactor * 1.7) min 2;
},
[_patient],
180] call CBA_fnc_waitAndExecute; /// 3m
...
[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = (TAG_originalSwayFactor * 2) min 2;
},
[_patient],
...
[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = (TAG_originalSwayFactor * 1.4) min 2;
},
[_patient],
...
[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = (TAG_originalSwayFactor * 1.2) min 2;
},
[_patient],
...
[{
	params ["_patient"];
	ace_advanced_fatigue_swayFactor = TAG_originalSwayFactor;
},
[_patient],
