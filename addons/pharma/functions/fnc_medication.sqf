...
[_patient, "activity", ACELSTRING(medical_treatment,Activity_usedItem), [[_medic, false, true] call ACEFUNC(common,getName), getText (configFile >> _cfg >> _usedItem >> "displayName")]] call ACEFUNC(medical_treatment,addToLog);
