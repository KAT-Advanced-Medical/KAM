...
def main():
    ...
    print("""
  #################################################
  # KAT ADV Medical Development Environment Setup #
  #################################################

  This script will create your KAT ADV Medical dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your KAT ADV Medical project folder:
    [Arma 3 installation directory]\\{} => KAT ADV Medical project folder
    P:\\{}                              => KAT ADV Medical project folder
