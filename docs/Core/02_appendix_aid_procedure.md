...
{% step %}
### Revive the Patient
*   Administer Ammonium Carbonate, use the "Reorient Patient" action, or push Epinephrine to boost wake-up chances, then wait. *(See [Essential Values](01_essential_values.md) for wake-up requirements).*
{% endstep %}
{% endstepper %}
